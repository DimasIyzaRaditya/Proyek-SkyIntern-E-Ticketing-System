          ...
          : Column(
              children: [
                ...
                ListQueryControls(
                  ...
                  searchHint: 'Cari nama, email, telepon, atau ID...',
                ...
                Expanded(
                  child: _sortedUsers.isEmpty
                      ? const EmptyState(
                          ...
                          subtitle: 'Belum ada pengguna di kategori ini',
                        )
                      : RefreshIndicator(
  ...
  Future<void> _toggleBlock(Map<String, dynamic> user) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          isBlocked ? 'Buka Blokir Pengguna' : 'Blokir Pengguna',
