...
function PaymentSummaryPageContent() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#dbeafe_0%,#eef5ff_45%,#dbeafe_100%)]">
      ...
      <MainNav />
      <main className="mx-auto max-w-3xl px-3 py-8 sm:px-6 sm:py-12">
        <section className="rounded-3xl border border-blue-100 bg-white p-4 shadow-lg sm:p-8">
          <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
            <h1 className="text-2xl font-black text-slate-900 sm:text-3xl">Ringkasan Pembayaran</h1>
            <div className={`rounded-xl px-3 py-1.5 font-mono text-base font-bold sm:px-4 sm:py-2 sm:text-xl ${
              countdown === 0
