          ...
          <form className="mt-6 space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input value={email} onChange={(event) => setEmail(event.target.value)} type="email" placeholder="nama@email.com" className="w-full rounded-2xl border border-blue-100 bg-blue-50 py-3 pl-10 pr-4 outline-none ring-blue-200 focus:ring" />
              </div>
            </div>
            <div>
