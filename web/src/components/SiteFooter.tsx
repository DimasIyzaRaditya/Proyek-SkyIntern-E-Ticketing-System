...
export default function SiteFooter() {
  return (
    <footer className="border-t border-slate-100 bg-white/95 backdrop-blur">
      <div className="mx-auto grid max-w-7xl gap-5 px-6 py-8 text-sm text-slate-600 md:grid-cols-[1.2fr_auto] md:items-center">
        <div>
          <p className="inline-flex items-center gap-2 text-base font-bold text-blue-600">
            <Plane className="animate-float h-4 w-4" /> SkyIntern E-Ticketing
          </p>
