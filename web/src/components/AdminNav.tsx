...
export default function AdminNav() {
  ...
  return (
    <nav className="mb-6 rounded-2xl border border-blue-100 bg-white p-3 shadow-sm sm:p-4">
      ...
      <div className="grid grid-cols-2 gap-2 text-[11px] sm:flex sm:flex-wrap sm:text-sm">
        {menus.map((item) => {
          ...
          return (
            <Link
              ...
              className={`block min-w-0 overflow-hidden text-ellipsis whitespace-nowrap rounded-lg border px-3 py-2 text-center font-semibold transition-colors duration-200 sm:w-auto ${
                isActive
